...
export const EDUCATION = [
  ...
  },
  {
    ...
    description: `I learn more about MERN stack, while learning data science, programming and visualization of big data in the Collage. I'm developing ecommerce website with react and php, using MySQL database and AI based calculator with handwritten recognition. I also passed with Distinctions in all subjects except for the Network Security.`,
  },
  {
    year: "2022 - 2024",
    role: "Higher National Certificate (HNC)",
    company: "Info Myanmar College",
    description: `This is whern I have started deeply exploring computer science and web development, starting with HTML, CSS, JavaScript and Java. I focused on building a strong foundation in front-end development. This journey has ignited my passion for creating functional and visually appealing web applications. I passed with Distinctions in all the subjects.`,
  },
  {
    year: "2020 - 2022",
...
export const PROJECTS = [
  {
    title: "MyanTech E-commerce",
    image: project4,
    description:
      "MyanTech ECommerce website - A third-prize Code2Career hackathon award-winning solution",
    technologies: [
      "Typescript",
      "Next.js",
      "TailwindCss",
    ...
    demoLink: "https://team-ikigai.vercel.app/",
  },
  {
    title: "Sweet Productivity Suite",
    image: project5,
    description:
      "A platform for managing time, tasks, notes, and budgets, with features like tracking, organization, and all-in-one productivity management.",
    technologies: [
      "Typescript",
      "Next.js",
      "TailwindCss",
    ...
    demoLink: "https://sweet-productivity-suite.netlify.app/",
  },
  {
    title: "Trailblazers Ecommerce Website",
    image: project6,
    description:
      "Tour and Travel booking Ecommerce - Best Ecommerce award-winning project for the 4th IMU project show",
    technologies: [
      "Javascript",
      "React.js",
      "TailwindCss",
    ...
    demoLink: "https://www.youtube.com/watch?v=Gxp_LVSemtE",
  },
  {
    title: "TradeHub E-Commerce Website",
    image: project1,
    description:
...
export const CONTACT = {
  ...
  github: "https://github.com/MinKhantKyawSwar",
  facebook: "https://www.facebook.com/minkhant.kyawswar.frost",
};
